...
from kg.entity_linking.extract_wiki_file import WikiFileExtractor, LinkExtractor
from kg.entity_linking.extract_wiki_file import page_extractor, link_extractor, saver, list_files, get_queue
...
def first_page():
    ...
    file = 'enwiki-20210401-pages-articles-multistream1.xml-p1p41242.bz2'
    file_path = os.path.join(wiki_dir, file)
    # file_path = '/Users/tmorrill002/Documents/datasets/wikipedia/20210401/enwiki-20210401-pages-articles-multistream18.xml-p25216198p26716197.bz2'
...
def test_get_links(first_page):
    ...
    expected_links = {
        'AccessibleComputing': Counter({'Computer accessibility': 1})
    }
...
def test_save_load_json(first_page):
    ...
    expected_load = {'AccessibleComputing': {'Computer accessibility': 1}}
